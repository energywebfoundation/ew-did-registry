...
const { abi: abiOfferable, bytecode: bytecodeOfferable } = require('../packages/proxyIdentity/build/contracts/OfferableIdentity.json');
...
const identityLibraryFactory = new ContractFactory(abiOfferable, bytecodeOfferable, deployer);

identityLibraryFactory.deploy()
