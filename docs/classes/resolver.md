...
*Defined in [did-resolver/src/implementations/resolver.ts:47](https://github.com/energywebfoundation/ew-did-registry/blob/cf74adb/packages/did-resolver/src/implementations/resolver.ts#L47)*
