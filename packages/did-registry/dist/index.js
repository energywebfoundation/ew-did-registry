    ...
    DIDRegistry.prototype.read = function (did) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        temporaryFactory = new did_document_1.DIDDocumentFactory(did);
                        didDocumentLite = temporaryFactory.createLite(this.resolver, did);
                        return [4 /*yield*/, didDocumentLite.read(did)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, didDocumentLite];
                }
            });
        });
    };
