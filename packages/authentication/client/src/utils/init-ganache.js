...
import ethrReg from '@ew-did-registry/did-ethr-resolver/src/constants/EthereumDIDRegistry.json';
import { Methods } from '@ew-did-registry/did';  
  ...
  export const deployRegistry = async (fillAccounts) => {
  ...
  export const getSettings = async (fillAccounts) => {
    const registryAddress = await deployRegistry(fillAccounts)
    const settings = { address: registryAddress, abi: ethrReg.abi, method: Methods.Erc1056};
