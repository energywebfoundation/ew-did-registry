...
import { EthrRegistry } from "../EthrRegistry";

export class EthrRegistry__factory extends ContractFactory {
  constructor(signer?: Signer) {
    super(_abi, _bytecode, signer);
  }

  deploy(overrides?: TransactionOverrides): Promise<EthrRegistry> {
    return super.deploy(overrides) as Promise<EthrRegistry>;
  }
  getDeployTransaction(overrides?: TransactionOverrides): UnsignedTransaction {
    return super.getDeployTransaction(overrides);
  }
  attach(address: string): EthrRegistry {
    return super.attach(address) as EthrRegistry;
  }
  connect(signer: Signer): EthrRegistry__factory {
    return super.connect(signer) as EthrRegistry__factory;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): EthrRegistry {
    return new Contract(address, _abi, signerOrProvider) as EthrRegistry;
  }
}
