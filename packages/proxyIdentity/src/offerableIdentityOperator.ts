...
import { Operator, EwSigner, hexify, addressOf } from '@fl-did-registry/did-nft-resolver';
...
export class OfferableIdenitytOperator extends Operator {
   ...
   */
  constructor(owner: EwSigner, settings: RegistrySettings, identityAddr: string) {
